...
import com.j3dream.core.enums.MemorySizeType;
import com.j3dream.core.enums.TimeSpanType;
...
public final class ConvertUtils {
    ...
    public static String byte2FitMemorySize(final long byteSize, int precision) {
        ...
        } else if (byteSize < MemorySizeType.KB.getSize()) {
            return String.format("%." + precision + "fB", (double) byteSize);
        } else if (byteSize < MemorySizeType.MB.getSize()) {
            return String.format("%." + precision + "fKB", (double) byteSize / MemorySizeType.KB.getSize());
        } else if (byteSize < MemorySizeType.GB.getSize()) {
            return String.format("%." + precision + "fMB", (double) byteSize / MemorySizeType.MB.getSize());
        } else if (byteSize < MemorySizeType.TB.getSize()) {
            return String.format("%." + precision + "fGB", (double) byteSize / MemorySizeType.GB.getSize());
        } else {
            return String.format("%." + precision + "fTB", (double) byteSize / MemorySizeType.TB.getSize());
        }
    }
     ...
     * @param timeSpanType The unit of time span.
     *                     <ul>
     *                     <li>{@link TimeSpanType#MSEC}</li>
     *                     <li>{@link TimeSpanType#SEC }</li>
     *                     <li>{@link TimeSpanType#MIN }</li>
     *                     <li>{@link TimeSpanType#HOUR}</li>
     *                     <li>{@link TimeSpanType#DAY }</li>
     *                     <li>{@link TimeSpanType#WEEK }</li>
     *                     </ul>
     * @return milliseconds
     */
    public static long timeSpan2Millis(final long timeSpan, final TimeSpanType timeSpanType) {
        return timeSpan * timeSpanType.getSize();
    }
     ...
     */
    public static long millis2TimeSpan(final long millis, final TimeSpanType timeSpanType) {
        return millis / timeSpanType.getSize();
    }

    /**
     * Milliseconds to fit time span.
     *
     * @param millis    The milliseconds millis = 0, return null
    ...
    public static String millis2FitTimeSpan(long millis, int precision) {
        return TimeDateUtils.millis2FitTimeSpan(millis, precision);
    }
