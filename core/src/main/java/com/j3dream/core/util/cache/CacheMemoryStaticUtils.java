...
/**
 * <p>文件名称: CacheMemoryStaticUtils </p>
 * <p>所属包名: com.lumotime.core.util.cache</p>
 * <p>描述: 缓存工具类 该类直接使用为内存缓存 </p>
...
public final class CacheMemoryStaticUtils {
     ...
     */
    public static void put(final String key, final Object value, int saveTime) {
    ...
    public static void put(final String key,
                           final Object value,
                           final CacheMemoryUtils cacheMemoryUtils) {
     ...
     * @return the value if cache exists or null otherwise
     */
    public static <T> T get(final String key, final CacheMemoryUtils cacheMemoryUtils) {
     ...
     * @return the count of cache
     */
    public static int getCacheCount(final CacheMemoryUtils cacheMemoryUtils) {
     ...
     * @return {@code true}: success<br>{@code false}: fail
     */
    public static Object remove(final String key, final CacheMemoryUtils cacheMemoryUtils) {
     ...
     * @param cacheMemoryUtils The instance of {@link CacheMemoryUtils}.
     */
    public static void clear(final CacheMemoryUtils cacheMemoryUtils) {
