 ...
 * @version v1.0
 */
public abstract class BaseParentDialog extends Dialog {

    public BaseParentDialog(@NonNull Context context) {
        super(context);
    }

    public BaseParentDialog(@NonNull Context context, int themeResId) {
        super(context, themeResId);
    }

    protected BaseParentDialog(@NonNull Context context, boolean cancelable, @Nullable OnCancelListener cancelListener) {
