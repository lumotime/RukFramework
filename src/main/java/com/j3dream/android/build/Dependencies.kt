...
object Dependencies {
    ...
    object Framework {
        ...
        val idreader_android = buildDependency("com.j3dream.android:idreader", DepVersions.Framework.idreader_android)
        val arcface_android = buildDependency("com.j3dream.android:arcface", DepVersions.Framework.arcface_android)
        val net_android = buildDependency("com.j3dream.android:net", DepVersions.Framework.net_android)
        val camera_android = buildDependency("com.j3dream.android:camera", DepVersions.Framework.camera_android)
    }
    ...
    object AndroidX{
        ...
        // androidx 协程相关
        val concurrent_futures = buildDependency("androidx.concurrent:concurrent-futures", DepVersions.AndroidX.concurrent_futures)
        val concurrent_futures_ktx = buildDependency("androidx.concurrent:concurrent-futures-ktx", DepVersions.AndroidX.concurrent_futures)
        val arch_core_runtime = buildDependency("androidx.arch.core:core-runtime", DepVersions.AndroidX.arch_core)
        val arch_core_common = buildDependency("androidx.arch.core:core-common", DepVersions.AndroidX.arch_core)
        ...
        val material = buildDependency("com.google.android.material:material", DepVersions.AndroidX.material)
        // 用于提取 exif 信息
        val exifinterface = buildDependency("androidx.exifinterface:exifinterface", DepVersions.AndroidX.exifinterface)
        // 统一 emoji 表情包
        val emoji = buildDependency("androidx.emoji:emoji", DepVersions.AndroidX.emoji)
        val emoji_appcompat = buildDependency("androidx.emoji:emoji-appcompat", DepVersions.AndroidX.emoji)
        val emoji_bundled = buildDependency("androidx.emoji:emoji-bundled", DepVersions.AndroidX.emoji)
        // 管理应用启动
        val startup = buildDependency("androidx.startup:startup-runtime", DepVersions.AndroidX.startup)
        // viewpager2
        val viewpager2 = buildDependency("androidx.viewpager2:viewpager2", DepVersions.AndroidX.viewpager2)
        val room_runtime = buildDependency("androidx.room:room-runtime", DepVersions.AndroidX.jetpack_room)
        val room_ktx = buildDependency("androidx.room:room-ktx", DepVersions.AndroidX.jetpack_room)
        val room_rxjava2 = buildDependency("androidx.room:room-rxjava2", DepVersions.AndroidX.jetpack_room)
        val room_test = buildDependency("androidx.room:room-testing", DepVersions.AndroidX.jetpack_room)
        val camera_core = buildDependency("androidx.camera:camera-core", DepVersions.AndroidX.jetpack_camera)
        val camera_camera2 = buildDependency("androidx.camera:camera-camera2", DepVersions.AndroidX.jetpack_camera)
        val camera_lifecycle = buildDependency("androidx.camera:camera-lifecycle", DepVersions.AndroidX.jetpack_camera)
        val fragment = buildDependency("androidx.fragment:fragment", DepVersions.AndroidX.jetpack_fragment)
        val fragment_ktx = buildDependency("androidx.fragment:fragment-ktx", DepVersions.AndroidX.jetpack_fragment)
        val fragment_debug = buildDependency("androidx.fragment:fragment-testing", DepVersions.AndroidX.jetpack_fragment)
        val lifecycle_runtime = buildDependency("androidx.lifecycle:lifecycle-runtime-ktx", DepVersions.AndroidX.jetpack_lifecycle)
        val lifecycle_viewmodel_savedstate = buildDependency("androidx.lifecycle:lifecycle-viewmodel-savedstate", DepVersions.AndroidX.jetpack_lifecycle)
        val paging_runtime = buildDependency("androidx.paging:paging-runtime", DepVersions.AndroidX.jetpack_paging)
        val paging_rxjava2 = buildDependency("androidx.paging:paging-rxjava2", DepVersions.AndroidX.jetpack_paging)
        val work_runtime = buildDependency("androidx.work:work-runtime", DepVersions.AndroidX.jetpack_workmanager)
        val work_ktx = buildDependency("androidx.work:work-runtime-ktx", DepVersions.AndroidX.jetpack_workmanager)
        val work_rxjava2 = buildDependency("androidx.work:work-rxjava2", DepVersions.AndroidX.jetpack_workmanager)
    }
