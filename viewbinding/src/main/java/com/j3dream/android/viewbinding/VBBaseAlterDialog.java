...
/**
 * <p>文件名称: VBBaseAlterDialog </p>
 * <p>所属包名: com.j3dream.android.viewbinding</p>
 * <p>描述:  </p>
 * <p></p>
 * <p>创建时间: 2021/1/28 09:12 </p>
 *
 * @author <a href="mail to: cnrivkaer@outlook.com" rel="nofollow">lumo</a>
 * @version v1.0
 */
public abstract class VBBaseAlterDialog<VB extends ViewBinding> extends BaseParentDialog {
    private VB mViewBinding;

    protected VBBaseAlterDialog(@NonNull Context context) {
        super(context, 0);
    }

    protected VBBaseAlterDialog(@NonNull Context context, int themeResId) {
